                ...
                'input_schema' => [
                    ...
                    'properties' => [
                        ...
                        'assignee_ids' => [
                            'type' => 'array',
                            'items' => ['type' => 'integer'],
                            'description' => 'User IDs to assign. If omitted, defaults to the main platform owner. Pass an empty array to leave unassigned.',
                        ],
                    ],
                ...
                'input_schema' => [
                    ...
                    'properties' => [
                        ...
                        'assignee_ids' => [
                            'type' => 'array',
                            'items' => ['type' => 'integer'],
                            'description' => 'Full replacement list of assignees. Pass an empty array to remove all assignees. Omit the field to leave assignees unchanged.',
                        ],
                    ],
