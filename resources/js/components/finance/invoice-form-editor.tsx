                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between gap-3 space-y-0">
                            <div>
                                ...
                                <CardDescription>
                                    Add hourly lines or flat lines. For flat
                                    lines, leave hours and rate blank.
                                </CardDescription>
                            </div>
                            <Button
                                type="button"
