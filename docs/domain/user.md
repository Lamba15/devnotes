...
| timezone    | string, nullable | User's IANA timezone used for app-wide date/time rendering |
...
- Saved user timezone is the first choice for rendering timestamps across the app.
